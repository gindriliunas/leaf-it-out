        ...
        <div className="contact-grid">
          ...
          <div
            style={{
              ...
              padding: "40px",
              border: "1px solid rgba(107,191,62,0.15)",
              boxShadow: "0 8px 40px rgba(15,45,20,0.08)",
            }}
          >
            <h3 style={{ fontSize: "1.3rem", fontWeight: 800, color: "#0f2d14", marginBottom: 8 }}>
              Request a Free Quote
            </h3>
            <p style={{ fontSize: 14, color: "#4a6b42", marginBottom: 28 }}>
            ...
            <form
              onSubmit={(e) => {
                ...
                window.location.href = `mailto:leafitoutltd@gmail.com?subject=Quote Request from ${name}&body=Name: ${name}%0AEmail: ${email}%0APhone: ${phone}%0AService: ${service}%0A%0AMessage: ${message}`;
              }}
            ...
            >
              {[
                ...
                { name: "phone", label: "Phone Number", type: "tel", placeholder: "07700 900000" },
              ].map(({ name, label, type, placeholder }) => (
                <div key={name}>
                  <label
                    htmlFor={name}
                    style={{ display: "block", fontSize: 13, fontWeight: 600, color: "#0f2d14", marginBottom: 6 }}
                  >
                    {label}
                  </label>
                  <input
                    ...
                    style={{
                      ...
                      padding: "12px 16px",
                      borderRadius: 10,
                      border: "1.5px solid rgba(107,191,62,0.25)",
                      fontSize: 16,
                      color: "#0f2d14",
                      background: "#f8fdf5",
                      outline: "none",
                    ...
                    onBlur={(e) => (e.currentTarget.style.borderColor = "rgba(107,191,62,0.25)")}
                  />
                </div>
              ))}

              <div>
                <label htmlFor="service" style={{ display: "block", fontSize: 13, fontWeight: 600, color: "#0f2d14", marginBottom: 6 }}>
                  Service Required
                </label>
                <select
                  id="service"
                ...
                >
                  ...
                  <option>Driveways &amp; Block Paving</option>
                  <option>Patios &amp; Natural Stone</option>
              ...
              <div>
                <label htmlFor="message" style={{ display: "block", fontSize: 13, fontWeight: 600, color: "#0f2d14", marginBottom: 6 }}>
